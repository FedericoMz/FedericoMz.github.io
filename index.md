...
- **StockAgent** is a multi-agent AutoGen system that generates stock market suggestions. It includes a custom MCP server using yfinance. I am currently working on it in my free time.
